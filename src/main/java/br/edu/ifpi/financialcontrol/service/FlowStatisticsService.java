...
public interface FlowStatisticsService {
    List<FlowStatistics> calculateFlowGroupByDate(FlowType type, FlowStatisticsFilter statistics);
    List<FlowStatisticsWithCategoryName> calculateFlowStatisticsGroupByCategory(FlowType flowType, FlowStatisticsFilter statistics);
}
